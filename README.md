...
## Companion X/Twitter Operations

For social monitoring runs, pair this operations cockpit with
[Hermes Tweet](https://github.com/Xquik-dev/hermes-tweet). Hermes Tweet can
collect X/Twitter account, post, or trend context inside Hermes, while H-OPS can
keep the related assignments, progress, logs, outputs, and run history visible
from the dashboard. Hermes Tweet is a third-party project maintained by
Xquik-dev, not by this repository.
